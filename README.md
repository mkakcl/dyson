...
[![CI](https://github.com/BoothGroup/dyson/workflows/CI/badge.svg?branch=master)](https://github.com/BoothGroup/dyson/actions/workflows/ci.yaml?query=workflow%3ACI+branch%3Amaster)
